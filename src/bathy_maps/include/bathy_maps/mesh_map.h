...
namespace mesh_map {
    ...
    std::pair<Eigen::MatrixXd, BoundsT> height_map_from_pings(const data_structures::mbes_ping::PingsT& pings, double res);
    std::tuple<Eigen::MatrixXd, Eigen::MatrixXi, BoundsT> mesh_from_pings(const data_structures::mbes_ping::PingsT& pings, double res=0.5);
